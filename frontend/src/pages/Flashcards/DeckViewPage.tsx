      ...
      {loading ? (<div className="p-4">Loading…</div>) : !deck ? null : (
        <PageContainer>
          <div className="mb-6 flex items-center justify-between">
            <div>
              {deck.cls && (
                <button onClick={()=>navigate(`/class/${deck.cls.id}`)} className="mb-2 p-2 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Back to class">
          ...
          {/* Comments */}
          <div className="mt-8 bg-white rounded-2xl shadow-card border border-white/60 p-4">
